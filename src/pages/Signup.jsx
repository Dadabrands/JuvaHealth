    ...
    <>
      <div className="flex flex-col  px-2 md:px-20 py-4 md:py-12 bg-fuchsia-200 max-md:px-5">
        ...
        >
          ...
          <button className="justify-center items-center px-16 py-5 mt-4 mb-8 font-bold font-inter text-center text-black  bg-secondary whitespace-nowrap rounded-lg max-md:px-5 max-md:max-w-full">
              Sign Up as a Doctor
          </button>

          <p className="mt-4 leading-6 text-center font-inter text-zinc-800 max-md:max-w-full">
           Already have an account? <a href="/login">  <span className="font-extrabold text-purple-800">Sign Up</span></a>
          </p>
        </div>
      </div>
    </>
